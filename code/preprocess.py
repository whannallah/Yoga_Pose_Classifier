...
class Datasets():
    ...
    def __init__(self, data_path, task):
        ...
        self.test_data = self.get_data(
            os.path.join(self.data_path, "testsingle/"), task == '3', False, False)
    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            ...
            data_gen = tf.keras.preprocessing.image.ImageDataGenerator(width_shift_range=0.2, height_shift_range=0.2,
                                                                       horizontal_flip=True, preprocessing_function=self.preprocess_fn)
